...
<body>
    <header id="theNavigationBar">
        ...
        <section class="main__section">
            <div class='Section' >
                <form class="profile" action="availableHotelServlet" Method="Post" autocomplete="off">
                    <h3 class="sectionTitle">Enter Your Reservation Period</h3>
                    ...
                    <div class="buttons">
                        ...
                        <input type="submit" value="Search" class="btn fta-btn " />
                    </div>
