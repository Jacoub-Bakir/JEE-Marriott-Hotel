        ...
        <div class="container">
            ...
            <div class="content-box">
                <div class="pageHeader">
                    <h1>visitors List :</h1>
                    <div class="btns">
                    <a href="http://localhost:8080/TABD_TourismeProject/NewVisitorSrevlet" class="btn cta-btn">+ Add New Visitor</a>
                    </div>
                </div>
                <table>
                    <thead>
                    ...
                    <tbody>
                        <c:if test = "${visitorsList.size() > 0}">
                         <c:forEach var="i" begin="0" end="${visitorsList.size()-1}" step="1"> 
                          <tr>
                         
                           <td><c:out value="${visitorsList[i].nomVisiteur}" /></td>
                           <td><c:out value="${visitorsList[i].adress}" /></td>
                           <td><c:out value="0${visitorsList[i].tel}" /></td>
                        ...
                        <c:if test = "${visitorsList.size() == 0}">
                            ...
                            <tr>
                                <td class="centerRow">No Visitor Registered</td>
                            </tr>
                        </c:if>
