                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <c:if test = "${roomsList.size() != 0}">
                         <c:forEach var="i" begin="0" end="${roomsList.size()-1}" step="1" varStatus="loop"> 
                          <tr>
                           ...
                           <td> <a class="btn table_btn " href="reserverDatesServlet?chambre=${roomsList[i].numero}&hotel=${roomsList[i].hotel}&reservationDates=${reservationDates}" >Reserver</a> </td>
                        ...
                        <c:if test = "${roomsList.size() == 0}">
                            ...
                            <tr>
                                <td class="centerRow">No Room Available</td>
                            </tr>
                        </c:if>
